...
image_path = '..\images_S\Antonio_Vivaldi-Summer_1.png'
...
#    io.imshow(image)
    image = Img.process_img_S(image_path)
    image = np.array(Img.arr_to_img(image))
...
with tf.Session() as sess:
    ...
    reshaped_image = image.reshape(train_size ** 2, -1)
...
to_show = new_image.reshape(test_size, test_size, -1)
